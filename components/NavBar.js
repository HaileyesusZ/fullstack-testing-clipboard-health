    ...
    return (
        <div className="flex justify-between py-3 px-12 items-center bg-white">
            ...
            <div className="flex items-center space-x-6 ">
                <button className="border border-blue-500 border-solid rounded text-blue-500 px-2 py-1 uppercase font-medium text-sm hover:bg-blue-500 hover:text-white h-10">Create Job</button>
                <div className="relative bg-blue-500 rounded-full w-10 h-10 flex justify-center items-center uppercase">
                    ...
                    <div className="bg-red-500 absolute w-6 h-6 text-white text-xs flex justify-center items-center rounded-full -top-1 -right-2 border-2 border-white"><span>2</span></div>

                </div>
                <button className="text-gray-900 uppercase text-sm font-medium">Logout</button>
            </div>
